...
class ThreeLayerConvNet(object):
  ...
  def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
    ...
    # After conv-relu-pool, spatial dimensions are halved (H/2, W/2)
    pool_H = H // 2
    pool_W = W // 2
  ...
  def loss(self, X, y=None):
    ...
    # Layer 2 backward: ReLU - Affine 
    dconv_relu_pool_out, grads['W2'], grads['b2'] = affine_relu_backward(daffine_relu_out, affine_relu_cache)
    grads['W2'] += self.reg * W2
    
    # Layer 1 backward: Pool - ReLU - Conv 
    dX, grads['W1'], grads['b1'] = conv_relu_pool_backward(dconv_relu_pool_out, conv_relu_pool_cache)
